...
if last_10_spins:
    ...
    if st.button("Get Prediction"):
        ...
        # Convert predicted values to integers before using as dictionary keys
        next_dozen_1 = int(next_dozen_1)  # Ensure it's an integer
        next_dozen_2 = int(next_dozen_2)  # Ensure it's an integer
